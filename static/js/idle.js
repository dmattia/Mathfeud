...
var firebaseRef = new Firebase('https://mathfeud.firebaseio.com/presence/')	
function setUserStatus(current_status) {
	firebaseRef.set({userId: userId, status: current_status})
	$('#' + userId).text(current_status)
}
